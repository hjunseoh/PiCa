...
def train(
    ...
    print(f"trainable params: {trainable_params} || all params: {all_params} || trainable%: {trainable_percent}")
...
def parse_args():
    ...
    parser.add_argument('--adapter_name', type=str, default='pica', help='Adapter name')
